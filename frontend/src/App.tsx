...
import AdminDashboard from "./pages/Manager/VetDash";
      ...
      <Routes>
        ...
        
        {
          userRole?(
            ...
            <Route path="/manager-vet" element={  <Layout> <ManagerVet /></Layout>}/>
            <Route path="/pet" element={  <Layout> <Pet /></Layout>}/>       
            <Route path="/manager-breed" element={  <Layout> <ManagerBreed /></Layout>}/>
            <Route path="/manager-breed-type" element={  <Layout> <ManagerBreedType /></Layout>}/>
        </>
          ):(
            
            <>
            <Route path="/vet/dashboard" element={  <Layout> <VetDash /></Layout>}/>
            <Route path="/manager-my-hotel-booking" element={<Layout><ManagerBookingOfMyHotel /></Layout>}/>
            <Route path="/manager-statistics" element={<Layout><ManagerStatistics /></Layout>}/>    
            </>  
          )
        }
